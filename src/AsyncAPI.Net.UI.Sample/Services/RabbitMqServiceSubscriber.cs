...
[AsyncApiService(Version = "1.0.0", ServerProtocol = "rabbitmq")]
public class RabbitMqServiceSubscriber
{
    /// <summary>
    /// SubscribeEvent.
    ...
    [AsyncSubscribe(ChannelName = "RabbitMqServiceSubscriberV1_Message", OperationDescription = "handle event", MessageName = nameof(Message), MessageType = typeof(Message))]
    ...
    /// </summary>
    /// <param name="message"></param>
    [AsyncSubscribe(ChannelName = "RabbitMqServiceSubscriberV1_SimpleMessage", MessageType = typeof(SimpleMessage))]
